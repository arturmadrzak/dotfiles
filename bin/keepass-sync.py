...
class FileModifiedHandler(FileSystemEventHandler):
    ...
    # TODO: resolve, nope, manuall action needed. XC doesn't have option of
    # database merging as mobile app has :/
    def _handle_conflict(self):
        logging.error("conflict: remote and local modified")
        rtime = self.rclone.mtime(self.rfile)
        lrtime = self.meta.data["mtime"]
...
def main():
    ...
    meta_file = Path(XDG_DATA_HOME / "the_bundle.kdbx.json").resolve()
    r_disk = "secret-share"
